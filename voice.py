    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            if hour>= 0 and hour<18:
                ...
                speak("Thank you for your time. Have a Great Evening!")
            speak(assname)  
            exit()
 
        elif "who made you" in query or "who created you" in query:
            speak("I have been created by Byron.")
...
# needs
        ...
        elif "LightGrim" in query:
             
            wishMe()
            speak("LightGrim 1 point o in your service Mister")
            speak(assname)
...
def UiComponents(self):
    ...
    button.setGeometry(100, 200, 120, 20)

    # adding action to a button
    button.clicked.connect(run)

# the main for the gui to be executed
